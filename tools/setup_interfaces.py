...
def has_vyra_base_tag(file_path: Path) -> bool:
    ...
    try:
        with open(file_path, 'r') as f:
            ...
            return '# Generated by Vyra Copy Script' in first_lines
    except Exception:
        return False
...
def check_interface_conflicts(interface_package_path: Path, reserved_interfaces: dict) -> list:
    ...
    for dir_name in interface_dirs:
        ...
        for file_path in dir_path.glob(f'*.{dir_name}'):
            ...
            if filename in reserved_interfaces:
                ...
                error_msg = (
                    ...
                    f"Please rename your interface or remove it."
                )
                ...
                for item in data:
                    if 'functionname' in item:
                        ...
                        if func_name in reserved_functions:
                            ...
                            # Only report conflict if interface file doesn't have vyra_base tag
                            if not interface_file_found or not has_tag:
                                error_msg = (
