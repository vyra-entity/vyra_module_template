...
#ifndef VOS_MODULE_INTERFACES__SRV__DETAIL__GET_LOGS__FUNCTIONS_H_
#define VOS_MODULE_INTERFACES__SRV__DETAIL__GET_LOGS__FUNCTIONS_H_
 ...
 * calls
 * vos_module_interfaces__srv__GetLogs_Request__init().
...
/**
 * It calls
 * vos_module_interfaces__srv__GetLogs_Request__fini()
 ...
 * vos_module_interfaces__srv__GetLogs_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vos_module_interfaces__srv__GetLogs_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vos_module_interfaces__srv__GetLogs_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vos_module_interfaces
...
/**
 * It calls
 * vos_module_interfaces__srv__GetLogs_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vos_module_interfaces
...
/**
 * It allocates the memory for the array and calls
 * vos_module_interfaces__srv__GetLogs_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vos_module_interfaces
...
/**
 * It calls
 * vos_module_interfaces__srv__GetLogs_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VOS_MODULE_INTERFACES__SRV__DETAIL__GET_LOGS__FUNCTIONS_H_
