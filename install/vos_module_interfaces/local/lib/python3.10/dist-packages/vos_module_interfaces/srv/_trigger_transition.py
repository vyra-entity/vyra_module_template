...
class Metaclass_TriggerTransition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vos_module_interfaces.srv.TriggerTransition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vos_module_interfaces.srv import _trigger_transition
...
class TriggerTransition(metaclass=Metaclass_TriggerTransition):
    from vos_module_interfaces.srv._trigger_transition import TriggerTransition_Request as Request
    from vos_module_interfaces.srv._trigger_transition import TriggerTransition_Response as Response
