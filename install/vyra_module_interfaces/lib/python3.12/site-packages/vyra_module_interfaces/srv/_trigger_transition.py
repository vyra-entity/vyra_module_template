...
class Metaclass_TriggerTransition_Event(type):
    """Metaclass of message 'TriggerTransition_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__trigger_transition__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__trigger_transition__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__trigger_transition__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__trigger_transition__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__trigger_transition__event
...
class TriggerTransition_Event(metaclass=Metaclass_TriggerTransition_Event):
    """Message class 'TriggerTransition_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vyra_module_interfaces/TriggerTransition_Request, 1>',
        'response': 'sequence<vyra_module_interfaces/TriggerTransition_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'TriggerTransition_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'TriggerTransition_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import TriggerTransition_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, TriggerTransition_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TriggerTransition_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import TriggerTransition_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TriggerTransition_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TriggerTransition_Response'"
...
class Metaclass_TriggerTransition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _trigger_transition.Metaclass_TriggerTransition_Event._TYPE_SUPPORT is None:
                _trigger_transition.Metaclass_TriggerTransition_Event.__import_type_support__()
...
class TriggerTransition(metaclass=Metaclass_TriggerTransition):
    ...
    from vyra_module_interfaces.srv._trigger_transition import TriggerTransition_Event as Event
