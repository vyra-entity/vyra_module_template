...
class Metaclass_HealthCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vyra_module_interfaces.srv.HealthCheck')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vyra_module_interfaces.srv import _health_check
...
class HealthCheck(metaclass=Metaclass_HealthCheck):
    from vyra_module_interfaces.srv._health_check import HealthCheck_Request as Request
    from vyra_module_interfaces.srv._health_check import HealthCheck_Response as Response
