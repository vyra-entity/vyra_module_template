...
class Init_HealthCheck_Event_response
{
public:
  explicit Init_HealthCheck_Event_response(::vyra_module_interfaces::srv::HealthCheck_Event & msg)
  : msg_(msg)
  {}
  ::vyra_module_interfaces::srv::HealthCheck_Event response(::vyra_module_interfaces::srv::HealthCheck_Event::_response_type arg)
  {
...
private:
  ::vyra_module_interfaces::srv::HealthCheck_Event msg_;
};

class Init_HealthCheck_Event_request
{
public:
  explicit Init_HealthCheck_Event_request(::vyra_module_interfaces::srv::HealthCheck_Event & msg)
  : msg_(msg)
  {}
  Init_HealthCheck_Event_response request(::vyra_module_interfaces::srv::HealthCheck_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_HealthCheck_Event_response(msg_);
  }
...
class Init_HealthCheck_Event_info
{
public:
  Init_HealthCheck_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_HealthCheck_Event_request info(::vyra_module_interfaces::srv::HealthCheck_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_HealthCheck_Event_request(msg_);
  }
...
template<>
inline
auto build<::vyra_module_interfaces::srv::HealthCheck_Event>()
{
  return vyra_module_interfaces::srv::builder::Init_HealthCheck_Event_info();
}
