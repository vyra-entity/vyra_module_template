...
[[deprecated("use vyra_module_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const vyra_module_interfaces::srv::GetCapabilities_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  vyra_module_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use vyra_module_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const vyra_module_interfaces::srv::GetCapabilities_Event & msg)
{
  return vyra_module_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<vyra_module_interfaces::srv::GetCapabilities_Event>()
{
  return "vyra_module_interfaces::srv::GetCapabilities_Event";
}

template<>
inline const char * name<vyra_module_interfaces::srv::GetCapabilities_Event>()
{
  return "vyra_module_interfaces/srv/GetCapabilities_Event";
}

template<>
struct has_fixed_size<vyra_module_interfaces::srv::GetCapabilities_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vyra_module_interfaces::srv::GetCapabilities_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<vyra_module_interfaces::srv::GetCapabilities_Request>::value && has_bounded_size<vyra_module_interfaces::srv::GetCapabilities_Response>::value> {};

template<>
struct is_message<vyra_module_interfaces::srv::GetCapabilities_Event>
  : std::true_type {};
