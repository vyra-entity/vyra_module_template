...
#ifndef VYRA_MODULE_INTERFACES__MSG__DETAIL__ERROR_FEED__TRAITS_HPP_
#define VYRA_MODULE_INTERFACES__MSG__DETAIL__ERROR_FEED__TRAITS_HPP_
...
inline void to_yaml(
  const vyra_module_interfaces::msg::ErrorFeed & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const vyra_module_interfaces::msg::ErrorFeed & msg)
{
  return vyra_module_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vyra_module_interfaces::msg::ErrorFeed>()
{
  return "vyra_module_interfaces::msg::ErrorFeed";
}

template<>
inline const char * name<vyra_module_interfaces::msg::ErrorFeed>()
{
  return "vyra_module_interfaces/msg/ErrorFeed";
}

template<>
struct has_fixed_size<vyra_module_interfaces::msg::ErrorFeed>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vyra_module_interfaces::msg::ErrorFeed>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<vyra_module_interfaces::msg::ErrorFeed>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VYRA_MODULE_INTERFACES__MSG__DETAIL__ERROR_FEED__TRAITS_HPP_
