...
#include "vos_module_interfaces/srv/detail/get_logs__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces::srv::GetLogs_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::GetLogs_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::GetLogs_Request *>(
    untyped_ros_message);
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetLogs_Request__handle;
}
...
{
bool cdr_serialize(
  const vos_module_interfaces::msg::LoggerStream &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  vos_module_interfaces::msg::LoggerStream &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: log_messages
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vos_module_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  vos_module_interfaces::srv::GetLogs_Response & ros_message)
{
  // Member: log_messages
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vos_module_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vos_module_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vos_module_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_LoggerStream(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vos_module_interfaces::srv::GetLogs_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::GetLogs_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::GetLogs_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetLogs_Response__handle;
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetLogs__handle;
}
