...
#include "vos_module_interfaces/srv/detail/get_capabilities__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vos_module_interfaces::srv::GetCapabilities_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vos_module_interfaces::srv::GetCapabilities_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces::srv::GetCapabilities_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::GetCapabilities_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::GetCapabilities_Request *>(
    untyped_ros_message);
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, GetCapabilities_Request)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vos_module_interfaces
cdr_serialize(
  const vos_module_interfaces::srv::GetCapabilities_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: capabilities
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vos_module_interfaces::srv::GetCapabilities_Response & ros_message)
{
  // Member: capabilities
  {
    cdr >> ros_message.capabilities;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vos_module_interfaces::srv::GetCapabilities_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::GetCapabilities_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::GetCapabilities_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, GetCapabilities_Response)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities_Response__handle;
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, GetCapabilities)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_GetCapabilities__handle;
}
