...
#include "vos_module_interfaces/srv/detail/trigger_transition__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vos_module_interfaces::srv::TriggerTransition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vos_module_interfaces::srv::TriggerTransition_Request & ros_message)
{
  // Member: transition_name
  cdr >> ros_message.transition_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces::srv::TriggerTransition_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::TriggerTransition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::TriggerTransition_Request *>(
    untyped_ros_message);
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, TriggerTransition_Request)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vos_module_interfaces
cdr_serialize(
  const vos_module_interfaces::srv::TriggerTransition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vos_module_interfaces::srv::TriggerTransition_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vos_module_interfaces::srv::TriggerTransition_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::srv::TriggerTransition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::srv::TriggerTransition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, TriggerTransition_Response)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition_Response__handle;
}
...
{
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, srv, TriggerTransition)() {
  return &vos_module_interfaces::srv::typesupport_fastrtps_cpp::_TriggerTransition__handle;
}
