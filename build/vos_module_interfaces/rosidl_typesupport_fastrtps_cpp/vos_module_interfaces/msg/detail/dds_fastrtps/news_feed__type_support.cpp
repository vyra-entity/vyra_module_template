...
#include "vos_module_interfaces/msg/detail/news_feed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vos_module_interfaces::msg::NewsFeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vos_module_interfaces::msg::NewsFeed & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces::msg::NewsFeed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vos_module_interfaces::msg::NewsFeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vos_module_interfaces::msg::NewsFeed *>(
    untyped_ros_message);
...
{
  return &vos_module_interfaces::msg::typesupport_fastrtps_cpp::_NewsFeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, msg, NewsFeed)() {
  return &vos_module_interfaces::msg::typesupport_fastrtps_cpp::_NewsFeed__handle;
}
