...
#include "vos_module_interfaces/srv/detail/get_logs__rosidl_typesupport_fastrtps_c.h"
...
using _GetLogs_Request__ros_msg_type = vos_module_interfaces__srv__GetLogs_Request;
...
size_t get_serialized_size_vos_module_interfaces__srv__GetLogs_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetLogs_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__srv__GetLogs_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t max_serialized_size_vos_module_interfaces__srv__GetLogs_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces__srv__GetLogs_Request;
    is_plain =
      (
...
static size_t _GetLogs_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__srv__GetLogs_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs_Request)() {
...
#include "vos_module_interfaces/msg/detail/logger_stream__functions.h"  // log_messages

// forward declare type support functions
size_t get_serialized_size_vos_module_interfaces__msg__LoggerStream(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_vos_module_interfaces__msg__LoggerStream(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, msg, LoggerStream)();


using _GetLogs_Response__ros_msg_type = vos_module_interfaces__srv__GetLogs_Response;
  ...
  // Field name: log_messages
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vos_module_interfaces, msg, LoggerStream
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: log_messages
  {
    ...
    if (ros_message->log_messages.data) {
      vos_module_interfaces__msg__LoggerStream__Sequence__fini(&ros_message->log_messages);
    }
    if (!vos_module_interfaces__msg__LoggerStream__Sequence__init(&ros_message->log_messages, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t get_serialized_size_vos_module_interfaces__srv__GetLogs_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetLogs_Response__ros_msg_type * ros_message = static_cast<const _GetLogs_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vos_module_interfaces__msg__LoggerStream(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__srv__GetLogs_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t max_serialized_size_vos_module_interfaces__srv__GetLogs_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vos_module_interfaces__msg__LoggerStream(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vos_module_interfaces__srv__GetLogs_Response;
    is_plain =
      (
...
static size_t _GetLogs_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__srv__GetLogs_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs_Response)() {
...
// already included above
// #include "vos_module_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vos_module_interfaces/srv/get_logs.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs)() {
