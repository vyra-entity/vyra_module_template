...
#include "vos_module_interfaces/srv/detail/trigger_transition__rosidl_typesupport_fastrtps_c.h"
...
using _TriggerTransition_Request__ros_msg_type = vos_module_interfaces__srv__TriggerTransition_Request;
...
size_t get_serialized_size_vos_module_interfaces__srv__TriggerTransition_Request(
  const void * untyped_ros_message,
...
static uint32_t _TriggerTransition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__srv__TriggerTransition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t max_serialized_size_vos_module_interfaces__srv__TriggerTransition_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces__srv__TriggerTransition_Request;
    is_plain =
      (
...
static size_t _TriggerTransition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__srv__TriggerTransition_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition_Request)() {
...
using _TriggerTransition_Response__ros_msg_type = vos_module_interfaces__srv__TriggerTransition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t get_serialized_size_vos_module_interfaces__srv__TriggerTransition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TriggerTransition_Response__ros_msg_type * ros_message = static_cast<const _TriggerTransition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__srv__TriggerTransition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t max_serialized_size_vos_module_interfaces__srv__TriggerTransition_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vos_module_interfaces__srv__TriggerTransition_Response;
    is_plain =
      (
...
static size_t _TriggerTransition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__srv__TriggerTransition_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition_Response)() {
...
// already included above
// #include "vos_module_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vos_module_interfaces/srv/trigger_transition.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition)() {
