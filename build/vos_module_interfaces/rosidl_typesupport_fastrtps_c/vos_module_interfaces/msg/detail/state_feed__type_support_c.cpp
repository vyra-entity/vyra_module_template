...
#include "vos_module_interfaces/msg/detail/state_feed__rosidl_typesupport_fastrtps_c.h"
...
using _StateFeed__ros_msg_type = vos_module_interfaces__msg__StateFeed;
...
size_t get_serialized_size_vos_module_interfaces__msg__StateFeed(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StateFeed__ros_msg_type * ros_message = static_cast<const _StateFeed__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StateFeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__msg__StateFeed(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vos_module_interfaces
size_t max_serialized_size_vos_module_interfaces__msg__StateFeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces__msg__StateFeed;
    is_plain =
      (
...
static size_t _StateFeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__msg__StateFeed(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, msg, StateFeed)() {
