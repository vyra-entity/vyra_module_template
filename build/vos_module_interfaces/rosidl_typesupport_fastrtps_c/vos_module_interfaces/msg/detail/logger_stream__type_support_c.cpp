...
#include "vos_module_interfaces/msg/detail/logger_stream__rosidl_typesupport_fastrtps_c.h"
...
using _LoggerStream__ros_msg_type = vos_module_interfaces__msg__LoggerStream;
  ...
  void * untyped_ros_message)
{
  ...
  _LoggerStream__ros_msg_type * ros_message = static_cast<_LoggerStream__ros_msg_type *>(untyped_ros_message);
  // Field name: log_level
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LoggerStream__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vos_module_interfaces__msg__LoggerStream(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vos_module_interfaces__msg__LoggerStream;
    is_plain =
      (
...
static size_t _LoggerStream__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vos_module_interfaces__msg__LoggerStream(
