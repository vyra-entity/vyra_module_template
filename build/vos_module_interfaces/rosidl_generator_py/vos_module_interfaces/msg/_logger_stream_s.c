...
bool vos_module_interfaces__msg__logger_stream__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vos_module_interfaces.msg._logger_stream.LoggerStream", full_classname_dest, 53) == 0);
  }
  vos_module_interfaces__msg__LoggerStream * ros_message = _ros_message;
  {  // log_level
...
{
  /* NOTE(esteve): Call constructor of LoggerStream */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vos_module_interfaces.msg._logger_stream");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoggerStream");
