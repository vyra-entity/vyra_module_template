...
class Metaclass_GetCapabilities(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vos_module_interfaces.srv.GetCapabilities')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vos_module_interfaces.srv import _get_capabilities
...
class GetCapabilities(metaclass=Metaclass_GetCapabilities):
    from vos_module_interfaces.srv._get_capabilities import GetCapabilities_Request as Request
    from vos_module_interfaces.srv._get_capabilities import GetCapabilities_Response as Response
