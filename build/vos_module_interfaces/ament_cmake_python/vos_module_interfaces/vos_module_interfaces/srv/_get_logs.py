...
class GetLogs_Response(metaclass=Metaclass_GetLogs_Response):
    ...
    _fields_and_field_types = {
        'log_messages': 'sequence<vos_module_interfaces/LoggerStream>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vos_module_interfaces', 'msg'], 'LoggerStream')),  # noqa: E501
    )
...
class Metaclass_GetLogs(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vos_module_interfaces.srv.GetLogs')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vos_module_interfaces.srv import _get_logs
...
class GetLogs(metaclass=Metaclass_GetLogs):
    from vos_module_interfaces.srv._get_logs import GetLogs_Request as Request
    from vos_module_interfaces.srv._get_logs import GetLogs_Response as Response
