...
static const _NewsFeed_type_support_symbol_names_t _NewsFeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vos_module_interfaces, msg, NewsFeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vos_module_interfaces, msg, NewsFeed)),
  }
};
...
{
  return &::vos_module_interfaces::msg::rosidl_typesupport_cpp::NewsFeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vos_module_interfaces, msg, NewsFeed)() {
  return get_message_type_support_handle<vos_module_interfaces::msg::NewsFeed>();
}
