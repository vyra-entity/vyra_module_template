...
{
  new (message_memory) vos_module_interfaces::srv::GetLogs_Request(_init);
}

void GetLogs_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vos_module_interfaces::srv::GetLogs_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetLogs_Request_message_member_array[2] = {
  {
    ...
    offsetof(vos_module_interfaces::srv::GetLogs_Request, log_lines),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vos_module_interfaces::srv::GetLogs_Request, log_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetLogs_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(vos_module_interfaces::srv::GetLogs_Request),
...
{
  return &::vos_module_interfaces::srv::rosidl_typesupport_introspection_cpp::GetLogs_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vos_module_interfaces, srv, GetLogs_Request)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_introspection_cpp::GetLogs_Request_message_type_support_handle;
}
...
void GetLogs_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) vos_module_interfaces::srv::GetLogs_Response(_init);
}

void GetLogs_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vos_module_interfaces::srv::GetLogs_Response *>(message_memory);
  typed_message->~GetLogs_Response();
}

size_t size_function__GetLogs_Response__log_messages(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<vos_module_interfaces::msg::LoggerStream> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<vos_module_interfaces::msg::LoggerStream> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<vos_module_interfaces::msg::LoggerStream> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const vos_module_interfaces::msg::LoggerStream *>(
    get_const_function__GetLogs_Response__log_messages(untyped_member, index));
  auto & value = *reinterpret_cast<vos_module_interfaces::msg::LoggerStream *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<vos_module_interfaces::msg::LoggerStream *>(
    get_function__GetLogs_Response__log_messages(untyped_member, index));
  const auto & value = *reinterpret_cast<const vos_module_interfaces::msg::LoggerStream *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetLogs_Response_message_member_array[1] = {
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<vos_module_interfaces::msg::LoggerStream>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(vos_module_interfaces::srv::GetLogs_Response, log_messages),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetLogs_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(vos_module_interfaces::srv::GetLogs_Response),
...
{
  return &::vos_module_interfaces::srv::rosidl_typesupport_introspection_cpp::GetLogs_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vos_module_interfaces, srv, GetLogs_Response)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_introspection_cpp::GetLogs_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetLogs_service_members = {
  ...
  // see get_service_type_support_handle<vos_module_interfaces::srv::GetLogs>()
...
get_service_type_support_handle<vos_module_interfaces::srv::GetLogs>()
{
  ...
  auto service_type_support =
    &::vos_module_interfaces::srv::rosidl_typesupport_introspection_cpp::GetLogs_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::vos_module_interfaces::srv::GetLogs_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::vos_module_interfaces::srv::GetLogs_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vos_module_interfaces, srv, GetLogs)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<vos_module_interfaces::srv::GetLogs>();
}
