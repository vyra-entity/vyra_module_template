...
{
  new (message_memory) vos_module_interfaces::msg::LoggerStream(_init);
}

void LoggerStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vos_module_interfaces::msg::LoggerStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoggerStream_message_member_array[3] = {
  {
    ...
    offsetof(vos_module_interfaces::msg::LoggerStream, log_level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vos_module_interfaces::msg::LoggerStream, log_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vos_module_interfaces::msg::LoggerStream, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoggerStream_message_members = {
  ...
  3,  // number of fields
  sizeof(vos_module_interfaces::msg::LoggerStream),
...
{
  return &::vos_module_interfaces::msg::rosidl_typesupport_introspection_cpp::LoggerStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vos_module_interfaces, msg, LoggerStream)() {
  return &::vos_module_interfaces::msg::rosidl_typesupport_introspection_cpp::LoggerStream_message_type_support_handle;
}
