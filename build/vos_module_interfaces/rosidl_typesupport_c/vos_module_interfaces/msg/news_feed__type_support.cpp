...
static const _NewsFeed_type_support_symbol_names_t _NewsFeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, msg, NewsFeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, msg, NewsFeed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, msg, NewsFeed)() {
  return &::vos_module_interfaces::msg::rosidl_typesupport_c::NewsFeed_message_type_support_handle;
}
