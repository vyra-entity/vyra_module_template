...
static const _HealthCheck_Request_type_support_symbol_names_t _HealthCheck_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, HealthCheck_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, HealthCheck_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, HealthCheck_Request)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::HealthCheck_Request_message_type_support_handle;
}
...
static const _HealthCheck_Response_type_support_symbol_names_t _HealthCheck_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, HealthCheck_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, HealthCheck_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, HealthCheck_Response)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::HealthCheck_Response_message_type_support_handle;
}
...
static const _HealthCheck_type_support_symbol_names_t _HealthCheck_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, HealthCheck)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, HealthCheck)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, HealthCheck)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::HealthCheck_service_type_support_handle;
}
