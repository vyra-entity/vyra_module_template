...
static const _GetLogs_Request_type_support_symbol_names_t _GetLogs_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, GetLogs_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, GetLogs_Request)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::GetLogs_Request_message_type_support_handle;
}
...
static const _GetLogs_Response_type_support_symbol_names_t _GetLogs_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, GetLogs_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, GetLogs_Response)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::GetLogs_Response_message_type_support_handle;
}
...
static const _GetLogs_type_support_symbol_names_t _GetLogs_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, GetLogs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, GetLogs)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, GetLogs)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::GetLogs_service_type_support_handle;
}
