...
static const _TriggerTransition_Request_type_support_symbol_names_t _TriggerTransition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, TriggerTransition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, TriggerTransition_Request)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::TriggerTransition_Request_message_type_support_handle;
}
...
static const _TriggerTransition_Response_type_support_symbol_names_t _TriggerTransition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, TriggerTransition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, TriggerTransition_Response)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::TriggerTransition_Response_message_type_support_handle;
}
...
static const _TriggerTransition_type_support_symbol_names_t _TriggerTransition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vos_module_interfaces, srv, TriggerTransition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vos_module_interfaces, srv, TriggerTransition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vos_module_interfaces, srv, TriggerTransition)() {
  return &::vos_module_interfaces::srv::rosidl_typesupport_c::TriggerTransition_service_type_support_handle;
}
