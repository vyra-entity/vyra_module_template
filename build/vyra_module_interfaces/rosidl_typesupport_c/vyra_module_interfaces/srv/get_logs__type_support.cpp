...
static const _GetLogs_Request_type_support_symbol_names_t _GetLogs_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vyra_module_interfaces, srv, GetLogs_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vyra_module_interfaces, srv, GetLogs_Request)() {
  return &::vyra_module_interfaces::srv::rosidl_typesupport_c::GetLogs_Request_message_type_support_handle;
}
...
static const _GetLogs_Response_type_support_symbol_names_t _GetLogs_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vyra_module_interfaces, srv, GetLogs_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vyra_module_interfaces, srv, GetLogs_Response)() {
  return &::vyra_module_interfaces::srv::rosidl_typesupport_c::GetLogs_Response_message_type_support_handle;
}
...
static const _GetLogs_Event_type_support_symbol_names_t _GetLogs_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vyra_module_interfaces, srv, GetLogs_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vyra_module_interfaces, srv, GetLogs_Event)() {
  return &::vyra_module_interfaces::srv::rosidl_typesupport_c::GetLogs_Event_message_type_support_handle;
}
...
static const _GetLogs_type_support_symbol_names_t _GetLogs_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vyra_module_interfaces, srv, GetLogs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs)),
  }
};
...
static const rosidl_service_type_support_t GetLogs_service_type_support_handle = {
  ...
  &GetLogs_Request_message_type_support_handle,
  &GetLogs_Response_message_type_support_handle,
  &GetLogs_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vyra_module_interfaces, srv, GetLogs)() {
  return &::vyra_module_interfaces::srv::rosidl_typesupport_c::GetLogs_service_type_support_handle;
}
