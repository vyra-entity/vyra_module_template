...
void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  vyra_module_interfaces__srv__GetLogs_Event__init(message_memory);
}

void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_fini_function(void * message_memory)
{
  vyra_module_interfaces__srv__GetLogs_Event__fini(message_memory);
}

size_t vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__size_function__GetLogs_Event__request(
  const void * untyped_member)
{
  const vyra_module_interfaces__srv__GetLogs_Request__Sequence * member =
    (const vyra_module_interfaces__srv__GetLogs_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__request(
  const void * untyped_member, size_t index)
{
  const vyra_module_interfaces__srv__GetLogs_Request__Sequence * member =
    (const vyra_module_interfaces__srv__GetLogs_Request__Sequence *)(untyped_member);
...
void * vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__request(
  void * untyped_member, size_t index)
{
  vyra_module_interfaces__srv__GetLogs_Request__Sequence * member =
    (vyra_module_interfaces__srv__GetLogs_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__fetch_function__GetLogs_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const vyra_module_interfaces__srv__GetLogs_Request * item =
    ((const vyra_module_interfaces__srv__GetLogs_Request *)
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__request(untyped_member, index));
  vyra_module_interfaces__srv__GetLogs_Request * value =
    (vyra_module_interfaces__srv__GetLogs_Request *)(untyped_value);
  *value = *item;
}

void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__assign_function__GetLogs_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  vyra_module_interfaces__srv__GetLogs_Request * item =
    ((vyra_module_interfaces__srv__GetLogs_Request *)
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__request(untyped_member, index));
  const vyra_module_interfaces__srv__GetLogs_Request * value =
    (const vyra_module_interfaces__srv__GetLogs_Request *)(untyped_value);
  *item = *value;
}

bool vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__resize_function__GetLogs_Event__request(
  void * untyped_member, size_t size)
{
  vyra_module_interfaces__srv__GetLogs_Request__Sequence * member =
    (vyra_module_interfaces__srv__GetLogs_Request__Sequence *)(untyped_member);
  vyra_module_interfaces__srv__GetLogs_Request__Sequence__fini(member);
  return vyra_module_interfaces__srv__GetLogs_Request__Sequence__init(member, size);
}

size_t vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__size_function__GetLogs_Event__response(
  const void * untyped_member)
{
  const vyra_module_interfaces__srv__GetLogs_Response__Sequence * member =
    (const vyra_module_interfaces__srv__GetLogs_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__response(
  const void * untyped_member, size_t index)
{
  const vyra_module_interfaces__srv__GetLogs_Response__Sequence * member =
    (const vyra_module_interfaces__srv__GetLogs_Response__Sequence *)(untyped_member);
...
void * vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__response(
  void * untyped_member, size_t index)
{
  vyra_module_interfaces__srv__GetLogs_Response__Sequence * member =
    (vyra_module_interfaces__srv__GetLogs_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__fetch_function__GetLogs_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const vyra_module_interfaces__srv__GetLogs_Response * item =
    ((const vyra_module_interfaces__srv__GetLogs_Response *)
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__response(untyped_member, index));
  vyra_module_interfaces__srv__GetLogs_Response * value =
    (vyra_module_interfaces__srv__GetLogs_Response *)(untyped_value);
  *value = *item;
}

void vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__assign_function__GetLogs_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  vyra_module_interfaces__srv__GetLogs_Response * item =
    ((vyra_module_interfaces__srv__GetLogs_Response *)
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__response(untyped_member, index));
  const vyra_module_interfaces__srv__GetLogs_Response * value =
    (const vyra_module_interfaces__srv__GetLogs_Response *)(untyped_value);
  *item = *value;
}

bool vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__resize_function__GetLogs_Event__response(
  void * untyped_member, size_t size)
{
  vyra_module_interfaces__srv__GetLogs_Response__Sequence * member =
    (vyra_module_interfaces__srv__GetLogs_Response__Sequence *)(untyped_member);
  vyra_module_interfaces__srv__GetLogs_Response__Sequence__fini(member);
  return vyra_module_interfaces__srv__GetLogs_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vyra_module_interfaces__srv__GetLogs_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(vyra_module_interfaces__srv__GetLogs_Event, request),  // bytes offset in struct
    NULL,  // default value
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__size_function__GetLogs_Event__request,  // size() function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__request,  // get_const(index) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__request,  // get(index) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__fetch_function__GetLogs_Event__request,  // fetch(index, &value) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__assign_function__GetLogs_Event__request,  // assign(index, value) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__resize_function__GetLogs_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(vyra_module_interfaces__srv__GetLogs_Event, response),  // bytes offset in struct
    NULL,  // default value
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__size_function__GetLogs_Event__response,  // size() function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_const_function__GetLogs_Event__response,  // get_const(index) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__get_function__GetLogs_Event__response,  // get(index) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__fetch_function__GetLogs_Event__response,  // fetch(index, &value) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__assign_function__GetLogs_Event__response,  // assign(index, value) function pointer
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__resize_function__GetLogs_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_members = {
  "vyra_module_interfaces__srv",  // message namespace
  "GetLogs_Event",  // message name
  3,  // number of fields
  sizeof(vyra_module_interfaces__srv__GetLogs_Event),
  false,  // has_any_key_member_
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_member_array,  // message members
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_type_support_handle = {
  0,
  &vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_vyra_module_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Event)() {
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Request)();
  vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Response)();
  if (!vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_type_support_handle.typesupport_identifier) {
    vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t vyra_module_interfaces__srv__detail__get_logs__rosidl_typesupport_introspection_c__GetLogs_service_type_support_handle = {
  ...
  &vyra_module_interfaces__srv__GetLogs_Request__rosidl_typesupport_introspection_c__GetLogs_Request_message_type_support_handle,
  &vyra_module_interfaces__srv__GetLogs_Response__rosidl_typesupport_introspection_c__GetLogs_Response_message_type_support_handle,
  &vyra_module_interfaces__srv__GetLogs_Event__rosidl_typesupport_introspection_c__GetLogs_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_vyra_module_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vyra_module_interfaces, srv, GetLogs_Event)()->data;
  }
