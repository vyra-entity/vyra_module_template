...
class Metaclass_GetLogs_Event(type):
    """Metaclass of message 'GetLogs_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_logs__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_logs__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_logs__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_logs__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_logs__event
...
class GetLogs_Event(metaclass=Metaclass_GetLogs_Event):
    """Message class 'GetLogs_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vyra_module_interfaces/GetLogs_Request, 1>',
        'response': 'sequence<vyra_module_interfaces/GetLogs_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'GetLogs_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'GetLogs_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import GetLogs_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetLogs_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetLogs_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import GetLogs_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetLogs_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetLogs_Response'"
...
class Metaclass_GetLogs(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_logs.Metaclass_GetLogs_Event._TYPE_SUPPORT is None:
                _get_logs.Metaclass_GetLogs_Event.__import_type_support__()
...
class GetLogs(metaclass=Metaclass_GetLogs):
    ...
    from vyra_module_interfaces.srv._get_logs import GetLogs_Event as Event
