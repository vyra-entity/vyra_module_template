...
bool cdr_serialize_vyra_module_interfaces__msg__ErrorFeed(
  const vyra_module_interfaces__msg__ErrorFeed * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vyra_module_interfaces
bool cdr_deserialize_vyra_module_interfaces__msg__ErrorFeed(
  eprosima::fastcdr::Cdr & cdr,
  vyra_module_interfaces__msg__ErrorFeed * ros_message)
{
  // Field name: error_code
  {
    cdr >> ros_message->error_code;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vyra_module_interfaces
bool cdr_serialize_key_vyra_module_interfaces__msg__ErrorFeed(
  const vyra_module_interfaces__msg__ErrorFeed * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: error_code
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vyra_module_interfaces
size_t get_serialized_size_key_vyra_module_interfaces__msg__ErrorFeed(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ErrorFeed__ros_msg_type * ros_message = static_cast<const _ErrorFeed__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vyra_module_interfaces
size_t max_serialized_size_key_vyra_module_interfaces__msg__ErrorFeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vyra_module_interfaces__msg__ErrorFeed * ros_message = static_cast<const vyra_module_interfaces__msg__ErrorFeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vyra_module_interfaces__msg__ErrorFeed(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vyra_module_interfaces__msg__ErrorFeed * ros_message = static_cast<vyra_module_interfaces__msg__ErrorFeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vyra_module_interfaces__msg__ErrorFeed(cdr, ros_message);
}
