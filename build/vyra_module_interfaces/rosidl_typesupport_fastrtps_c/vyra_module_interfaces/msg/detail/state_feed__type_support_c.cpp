  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vyra_module_interfaces__msg__StateFeed * ros_message = static_cast<const vyra_module_interfaces__msg__StateFeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vyra_module_interfaces__msg__StateFeed(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vyra_module_interfaces__msg__StateFeed * ros_message = static_cast<vyra_module_interfaces__msg__StateFeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vyra_module_interfaces__msg__StateFeed(cdr, ros_message);
}
