...
class Metaclass_HealthCheck_Event(type):
    """Metaclass of message 'HealthCheck_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__health_check__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__health_check__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__health_check__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__health_check__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__health_check__event
...
class HealthCheck_Event(metaclass=Metaclass_HealthCheck_Event):
    """Message class 'HealthCheck_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vyra_module_interfaces/HealthCheck_Request, 1>',
        'response': 'sequence<vyra_module_interfaces/HealthCheck_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'HealthCheck_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vyra_module_interfaces', 'srv'], 'HealthCheck_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import HealthCheck_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HealthCheck_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'HealthCheck_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vyra_module_interfaces.srv import HealthCheck_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HealthCheck_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'HealthCheck_Response'"
...
class Metaclass_HealthCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _health_check.Metaclass_HealthCheck_Event._TYPE_SUPPORT is None:
                _health_check.Metaclass_HealthCheck_Event.__import_type_support__()
...
class HealthCheck(metaclass=Metaclass_HealthCheck):
    ...
    from vyra_module_interfaces.srv._health_check import HealthCheck_Event as Event
