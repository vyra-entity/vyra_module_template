...
{
  new (message_memory) vyra_module_interfaces::msg::StateFeed(_init);
}

void StateFeed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vyra_module_interfaces::msg::StateFeed *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StateFeed_message_member_array[3] = {
  {
    ...
    offsetof(vyra_module_interfaces::msg::StateFeed, prev_state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vyra_module_interfaces::msg::StateFeed, current_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vyra_module_interfaces::msg::StateFeed, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StateFeed_message_members = {
  ...
  3,  // number of fields
  sizeof(vyra_module_interfaces::msg::StateFeed),
...
{
  return &::vyra_module_interfaces::msg::rosidl_typesupport_introspection_cpp::StateFeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vyra_module_interfaces, msg, StateFeed)() {
  return &::vyra_module_interfaces::msg::rosidl_typesupport_introspection_cpp::StateFeed_message_type_support_handle;
}
