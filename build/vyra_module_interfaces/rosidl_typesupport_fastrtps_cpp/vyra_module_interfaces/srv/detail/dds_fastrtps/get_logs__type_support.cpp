  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: log_messages
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      vyra_module_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.log_messages[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vyra_module_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.log_messages[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: log_messages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vyra_module_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_LoggerStream(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for vyra_module_interfaces::srv::GetLogs_Request already declared above

// functions for vyra_module_interfaces::srv::GetLogs_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vyra_module_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLogs_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vyra_module_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLogs_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vyra_module_interfaces::srv::GetLogs_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vyra_module_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLogs_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vyra_module_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLogs_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const vyra_module_interfaces::srv::GetLogs_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vyra_module_interfaces::srv::GetLogs_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLogs_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vyra_module_interfaces::srv::GetLogs_Event *>(
...
static size_t _GetLogs_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLogs_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLogs_Event__callbacks = {
  "vyra_module_interfaces::srv",
  "GetLogs_Event",
...
static rosidl_message_type_support_t _GetLogs_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLogs_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &vyra_module_interfaces::srv::typesupport_fastrtps_cpp::_GetLogs_Event__handle;
}
...
static const rosidl_service_type_support_t _GetLogs__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLogs__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<vyra_module_interfaces::srv::GetLogs_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<vyra_module_interfaces::srv::GetLogs_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<vyra_module_interfaces::srv::GetLogs_Event>(),
