...
#include "vyra_module_interfaces/msg/detail/state_feed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vyra_module_interfaces::msg::StateFeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vyra_module_interfaces::msg::StateFeed & ros_message)
{
  // Member: prev_state
  cdr >> ros_message.prev_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vyra_module_interfaces::msg::StateFeed;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vyra_module_interfaces
max_serialized_size_key_StateFeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const vyra_module_interfaces::msg::StateFeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vyra_module_interfaces::msg::StateFeed *>(
    untyped_ros_message);
...
{
  return &vyra_module_interfaces::msg::typesupport_fastrtps_cpp::_StateFeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vyra_module_interfaces, msg, StateFeed)() {
  return &vyra_module_interfaces::msg::typesupport_fastrtps_cpp::_StateFeed__handle;
}
