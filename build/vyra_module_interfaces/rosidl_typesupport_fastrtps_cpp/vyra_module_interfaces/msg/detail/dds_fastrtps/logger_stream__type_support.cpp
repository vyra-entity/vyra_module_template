...
{
  auto typed_message =
    static_cast<const vyra_module_interfaces::msg::LoggerStream *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vyra_module_interfaces::msg::LoggerStream *>(
    untyped_ros_message);
...
{
  return &vyra_module_interfaces::msg::typesupport_fastrtps_cpp::_LoggerStream__handle;
}
